...
const STEPS = [
  {
    ...
    desc: 'আপনার বর্তমান অনলাইন বিজনেস সেটআপ এবং ল্যান্ডিং পেজের ডাটা এনালাইসিস করে আমরা একটি কাস্টম রোডম্যাপ তৈরি করি।',
    icon: Icons.data,
    modal: {
  ...
  },
  {
    ...
    desc: 'আমরা আপনার জন্য এমন এক সিস্টেম তৈরি করি যা আপনার অনুপস্থিতিতেও কাস্টমারকে গাইড করবে।',
    icon: Icons.cog,
    modal: {
      ...
      <section id="process" className="process-section" ref={sectionRef} aria-label="আমাদের কাজের প্রক্রিয়া">
        <div className="container">
          ...
          <p className="process-sub">
            আমাদের ৪টি ধাপের বিশেষ কর্মপরিকল্পনা; অডিট থেকে শুরু করে স্কেলিং পর্যন্ত। বিস্তারিত জানতে প্রতিটি কার্ডে ট্যাপ করুন।
          </p>
