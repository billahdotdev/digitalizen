  ...
  return (
    <div className="bl-page">
      ...
      <header className="bl-topbar">
        ...
        <span className="bl-topbar-tag">সেলস ইঞ্জিন আর্কিটেকচার • ক্লাউড ইনফ্রাস্ট্রাকচার</span>
      </header>
