...
const PACKAGES = [
  {
    ...
    features: [
      '১ সেকেন্ডে AI রিপ্লাই; লিড লস ০%',
      'অটো ডাটা এন্ট্রি; ম্যানুয়াল কাজ শেষ',
      'পুরাতন কাস্টমার ফ্রি রি-টার্গেটিং',
      'অফিশিয়াল মেটা API ইনফ্রাস্ট্রাকচার',
    ],
  ...
  },
  {
    ...
    value:     25000,
    bottomLine: 'যারা দাম শুনে চলে যায়, তাদের সেল ফিরিয়ে আনুন। [১৫৬৮]',
    features: [
      'মুড-সেন্সিটিভ AI সেলস-রিপ',
      'স্মার্ট ফলো-আপ ও সেলস ক্লোজার',
      'ওয়েব-টু-ইনবক্স হাই-কনভার্শন ফানেল',
      'ইনস্ট্যান্ট ট্রাস্ট বিল্ডার কনফার্মেশন',
    ],
  ...
  },
  {
    ...
    value:     35000,
    bottomLine: 'ফেক অর্ডার এবং রিটার্ন লস চিরতরে বন্ধ করুন। [৫২০]',
    features: [
      'অ্যান্টি-ফেক COD (OTP ভেরিফিকেশন)',
      'পরিত্যক্ত কার্ট অটো-রেভিনিউ রিকভারি',
      'অমনিচ্যানেল AI ইকোসিস্টেম',
      'ব্র্যান্ডেড SMS ও ইমেইল অ্যালার্ট',
    ],
