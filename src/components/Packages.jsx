...
const PACKAGES = [
  {
    ...
    unit: '৳', amount: '১০,০০০', period: ' সেটআপ + ৳১০,০০০/মাস',
    setupNote: '*পেজ এবং ইনবক্স নির্ভর F Commerce ব্যবসার জন্য',
    value:     10000,
    bottomLine: '১ সেকেন্ডের দেরি মানে ২০% কাস্টমার হারানো।',
    features: [
      '১ সেকেন্ডে AI রিপ্লাই; কাস্টমারকে অন্য কোথাও যাওয়ার সুযোগই দেবেন না',
      'অ্যাড-টু-হোয়াটসঅ্যাপ অপারেশন ও প্রতিটি ক্লিকের নিখুঁত ট্র্যাকিং',
      'অটো ডাটা এন্ট্রি; কোনো ম্যানুয়াল কাজ ছাড়াই গুগল শিটে লিড সেভ',
      'অফিশিয়াল মেটা API; কোনো থার্ড-পার্টি সাবস্ক্রিপশন ফি লাগবে না',
      'আনলিমিটেড অ্যাড ক্যাম্পেইন পরিচালনা (অ্যাড বাজেট ও মেটা ফি ক্লায়েন্টের)'
    ],
  ...
  },
  {
    ...
    unit: '৳', amount: '৩০,০০০', period: ' সেটআপ + ৳২০,০০০/মাস',
    setupNote: '*ওয়েবসাইট এবং ইনবক্স, উভয় চ্যানেলের জন্য',
    value:     30000,
    bottomLine: 'যারা দাম শুনে চলে যায়, তাদের থেকে সেল ফিরিয়ে আনুন।',
    features: [
      ...
      'স্মার্ট ফলো-আপ ইঞ্জিন; যারা চুপ হয়ে যায় তাদের কনভার্ট করার মেশিন',
      'হাই-কনভার্শন সেলস ফানেল ও ১ সেকেন্ড লোডিং SPA ল্যান্ডিং পেজ',
      'মাল্টি-চ্যানেল অ্যাড পরিচালনা (FB/Google); অ্যাড কস্ট ও ডোমেইন-হোস্টিং ক্লায়েন্টের'
    ],
  ...
  },
  {
    ...
    unit: '৳', amount: '৫০,০০০', period: ' সেটআপ + ৳৩০,০০০/মাস',
    ...
    features: [
      ...
      'পরিত্যক্ত কার্ট রিকভারি; হারিয়ে যাওয়া চেকআউট থেকে অটো রেভিনিউ',
      'অমনিচ্যানেল AI ইঞ্জিন; FB, WA ও ওয়েবসাইট চলবে এক সেন্ট্রাল ব্রেইনে',
      'রিয়েল-টাইম প্রফিট ড্যাশবোর্ড ও পুরো সেলস ইঞ্জিন স্কেলিং সাপোর্ট',
      'অমনিচ্যানেল অ্যাড স্কেলিং; অ্যাড বাজেট ও SMS/OTP গেটওয়ে ফি ক্লায়েন্টের'
    ],
