...
const plans = [
  {
    ...
    stage: 'আর্লি স্টেজ',
    tier: 'Care+',
    tagline: 'শূন্য ঝুঁকিতে অনলাইন শুরু',
    priceCurrency: '৳', priceMain: '০', priceSub: 'সার্ভিস চার্জ নেই',
    features: [
      'Business Suite সেটআপ',
      'পেজ SEO অডিট',
      'প্রাথমিক ব্র্যান্ডিং সেটআপ',
      'স্ট্রাটেজি গাইডলাইন',
    ],
  ...
  return (
    <section id="packages" className="packages-section">
      <div className="container">
        ...
        <p  className="packages-hint">আর্লি স্টেজ থেকে মার্কেট লিডার পর্যন্ত তিনটি সুস্পষ্ট পথ।</p>
