...
const faqs = [
  {
    ...
    a: 'মাত্র $10/৳১,৪৫০ দিয়েই শুরু করতে পারবেন আমাদের মাইক্রো টেস্ট প্যাকেজের মাধ্যমে। এটি ছোট বাজেটে দ্রুত রেজাল্ট দেখার সেরা উপায়। বাজেট বেশি হলে সাপ্তাহিক বা মাসিক প্যাকেজও আছে।',
    cat: 'মূল্য',
  ...
  },
  {
    ...
    a: 'অ্যাড বাজেট মূলত আপনার বিজনেস গোল এবং ক্যাটাগরির ওপর নির্ভর করে। তবে আমাদের সাজেশন হলো, শুরুতে একটি টেস্ট বাজেট দিয়ে ক্যাম্পেইন স্টার্ট করা। এরপর ডাটা অ্যানালাইসিস করে যখন ভালো রেজাল্ট বা ROAS আসতে শুরু করবে, তখন ধীরে ধীরে বাজেট বাড়িয়ে আমরা স্কেলিং করি। এতে আপনার ইনভেস্টমেন্টের ঝুঁকি কমে এবং প্রফিটের হার বাড়ে।',
    cat: 'বাজেট',
