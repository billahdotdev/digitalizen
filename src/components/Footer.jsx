...
/* ─── Social icons — all 5, each a complete valid object ─── */
const socials = [
  {
    name: 'Facebook',
      ...
      <div className="container">
        <div className="footer__main">
          ...
          <div className="footer__brand">
            ...
            <p className="footer__tagline">
              কম খরচে বেশি রেজাল্ট।<br />
              ডেটা-চালিত মেটা অ্যাডস এজেন্সি।
            </p>
            ...
            <button
              ...
              onClick={() => {
                pixel('Contact', { content_name: 'Footer WhatsApp' })
            ...
            <div className="footer__socials" role="list" aria-label="সোশ্যাল মিডিয়া লিংক">
              {socials.map(s => (
                <a
                  ...
                  aria-label={s.name}
                  role="listitem"
                  onClick={() => pixel('Contact', { content_name: s.name + ' Footer' })}
                >
                  {s.icon}
                </a>
              ))}
        ...
        <div className="footer__bottom">
          ...
          <div className="footer__legal">
            <a href="#" onClick={e => e.preventDefault()}>প্রাইভেসি পলিসি</a>
            <span aria-hidden="true">·</span>
            <a href="#" onClick={e => e.preventDefault()}>শর্তাবলী</a>
            <span aria-hidden="true">·</span>
            <a href="#" onClick={e => e.preventDefault()}>রিফান্ড পলিসি</a>
          </div>
        </div>
      </div>
    </footer>
