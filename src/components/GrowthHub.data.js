...
export const AUDIT_QUESTIONS = [
  ...
  /* ── মার্কেটিং (১–৫) ─────────────────────────────────── */
  {
    ...
    hint: 'সঠিক কাস্টমার চিনতে ভুল করলে বিজ্ঞাপনের টাকা অপচয় হয়।',
    options: [
      { value:0, label:'জানি না', sub:'সঠিক কাস্টমার সম্পর্কে স্পষ্ট ধারণা নেই' },
  ...
  },
  {
    ...
    hint: 'ROAS = মোট বিক্রয় ÷ বিজ্ঞাপন খরচ। ৩ গুণ বা তার বেশি হওয়া দরকার।',
    options: [
      { value:0, label:'অ্যাড দেই না', sub:'এখনো পেইড মার্কেটিং শুরু করিনি' },
      { value:1, label:'১ টাকার কম ফেরত', sub:'খরচের চেয়ে বিক্রয় কম' },
  ...
  {
    id: 'mkt_4', domain: 'marketing', iconKey: 'smartphone',
    q: 'মোবাইলে আপনার ল্যান্ডিং পেজ বা ওয়েবসাইট দেখলে কাস্টমার কি কেনে?',
    hint: 'বাংলাদেশে ৯০% এর বেশি মানুষ মোবাইলে ব্রাউজ করেন।',
    options: [
      { value:0, label:'ল্যান্ডিং পেজ নাই', sub:'শুধু কল বা ইনবক্সে অর্ডার নিই' },
      { value:1, label:'ল্যান্ডিং পেজ আছে কিন্তু বিক্রি কম', sub:'মানুষ আসছে কিন্তু কিনছে না' },
      { value:3, label:'ল্যান্ডিং পেজ মোটামুটি ঠিকঠাক', sub:'বিক্রি হচ্ছে, তবে আরো ভালো হতে পারে' },
      { value:4, label:'ল্যান্ডিং পেজ অপ্টিমাইজড', sub:'নিয়মিত টেস্ট করি, কনভার্সন ভালো' },
    ],
  },

  {
    id: 'mkt_5', domain: 'marketing', iconKey: 'repeat2',
  ...
  },
  {
    ...
    q: 'একজন নতুন কাস্টমার পেতে আপনার মোট কত টাকা খরচ হয়?',
...
const DOMAIN_INSIGHTS = {
  marketing: {
    ...
    elite:    { title: 'মার্কেট লিডার — ব্র্যান্ড ইমেজ বিল্ড করুন',    detail: 'মার্কেটিং এলিট লেভেলে। লয়্যালটি প্রোগ্রাম ও কমিউনিটি বিল্ডিং শুরু করুন।',                                                                                        actions: ['লয়্যালটি প্রোগ্রাম ও রেফারেল সিস্টেম তৈরি করুন', 'ব্র্যান্ড কনটেন্ট মিডিয়া বিল্ড করুন', 'কমিউনিটি মার্কেটিং শুরু করুন'], urgency: 'low' },
  },
  operations: {
