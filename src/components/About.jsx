      ...
      <div className="container">
        ...
        <div className="about-main">
          ...
          <p className="about-desc">
            <strong>Digitalizen</strong> একটি রেজাল্ট-ফোকাসড এজেন্সি। আমরা বিশ্বাস করি সোশ্যাল মিডিয়া অ্যাডস তখনই কাজ করে, যখন এর পেছনে একটি শক্তিশালী <strong>ল্যান্ডিং পেজ</strong>, সঠিক <strong>ডেটা</strong>, এবং প্রপার <strong>অটোমেশন</strong> থাকে।
          </p>    
        </div>
